...
RSpec.describe User, type: :model do
  ...
  describe "favorite style" do
    ...
    it "is the style with highest rating average if several rated" do
      create_beer_of_different_style_or_rating({user: user}, 10, "Lager")
      create_beer_of_different_style_or_rating({user: user}, 15, "Lager")
      create_beer_of_different_style_or_rating({user: user}, 13, "Lager")
      create_beer_of_different_style_or_rating({user: user}, 30, "IPA")
      create_beer_of_different_style_or_rating({user: user}, 43, "IPA")
      best = "IPA"
...
def create_beer_of_different_style_or_rating(object, score, style)
